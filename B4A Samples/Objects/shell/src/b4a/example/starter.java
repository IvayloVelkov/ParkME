...
public static RemoteObject _ast = RemoteObject.declareNull("b4a.example.asyncstreamstext");
...
public static b4a.example.main _main = null;
  public Object[] GetGlobals() {
		return new Object[] {"admin",starter._admin,"ast",starter._ast,"connected",starter._connected,"connecting",starter._connecting,"Main",Debug.moduleToString(b4a.example.main.class),"serial",starter._serial,"Service",starter.mostCurrent._service};
}
}